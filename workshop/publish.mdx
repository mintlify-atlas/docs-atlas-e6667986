---
title: "Publish and Update Steam Workshop Addons"
...
| **Content Folder** | Local path to the folder (or file, for games that support single-file uploads) that contains the addon's content. |
...
<Steps>
  ...
  <Step title="Create the item">
    Click **Create Item**. Crowbar contacts Steam and reserves a new Workshop item ID, which appears in the Item ID field. The item is initially invisible to other users.
  </Step>
...
```text
Connection to Steam Workshop failed. This most likely means you need to login to Steam
or you do not own the app or game to which this item belongs.
```
