...
description: "Crowbar is an open-source Windows GUI for GoldSource and Source engine modding. Decompile models, compile QC scripts, manage VPK packages, and publish Workshop content."
---
...
| Version | Notes |
|---------|-------|
| v6 | Original Half-Life retail release |
